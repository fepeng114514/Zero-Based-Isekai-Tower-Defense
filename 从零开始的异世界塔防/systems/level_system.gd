...
func _initialize() -> void:
	var level_data: Dictionary = LevelMgr.levels_data[GlobalStore.level_idx]

	create_level_entities(level_data)
	# create_level_tower_holders(level_data)


func create_level_entities(level_data: Dictionary) -> void:
...
func create_level_tower_holders(level_data: Dictionary) -> void:
